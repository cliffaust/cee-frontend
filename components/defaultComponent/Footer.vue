<template>
  <footer class="footer py-8 px-8 bg-gray-200 mt-12 flex flex-col">
    ...
    <div class="mt-4 flex flex-wrap mb-12">
      ...
      <div class="link-box">
        <a href="#" class="link">Delivery Service</a>
      </div>
      <div class="link-box">
        <a href="#" class="link">Sell your book</a>
      </div>
      <div class="link-box">
    ...
    <div class="flex self-center">
      ...
      >
        ...
        <g
          ...
          fill-rule="evenodd"
        >
          <g id="Artboard-4" transform="translate(-708.000000, -863.000000)">
...
.logo {
  @apply h-16 object-cover cursor-pointer z-10;
}
</style>
